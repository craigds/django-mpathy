...
def test_get_cached_trees(db):
    ...
    # TODO: in yet-unreleased pytest-django:
    # https://github.com/pytest-dev/pytest-django/commit/89595e3ce335ca0cbea101851fa09ef2806a033e
